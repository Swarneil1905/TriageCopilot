const GAPS = [
  ...
  },
  {
    ...
    answer:
      "TriageCopilot's patient status is a state machine, not a field you can set. Nine statuses, explicit legal transitions between them, enforced inside the same transaction that writes the event -- so \"what's next for this patient\" is always a real, queryable answer instead of an assumption baked into the UI.",
  },
  {
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-12">
      ...
      <div className="mt-6 space-y-6">
        {GAPS.map((g) => (
          <div key={g.gap} className="rounded-lg border border-stone-200 p-5">
